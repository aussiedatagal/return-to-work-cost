      ...
      <div className="max-w-4xl mx-auto px-2 md:px-4 py-4 md:py-12">
        ...
        <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 md:p-8 mb-6 md:mb-8">
          <div className="text-center mb-4 md:mb-6">
            <h2 className="text-base md:text-2xl font-bold text-gray-900 mb-2 md:mb-3">
              Summary
            </h2>
          </div>
          <div className="space-y-3 md:space-y-4 text-sm md:text-base text-gray-700">
            <p>
              The Child Care Subsidy is designed to help families afford childcare, but for many families the 5th day of work often brings minimal or even negative financial benefit, making it financially difficult for many parents to return to work full-time.
            </p>
            <p>
              I hope this tool helps you make a more informed decision about your family's work and childcare arrangements.
            </p>
          </div>
        </div>
